...
import { Cn as from, Ft as concatMap, Yn as Observable, bt as distinct, fn as map, rn as timer } from "./zipWith-BIPy9JuQ.js";
import { t as _asyncToGenerator } from "./asyncToGenerator-B0cJ8fiL.js";
import { D as FirebaseError, H as isCloudWorkstation, I as getDefaultEmulatorHostnameAndPort, Q as pingServer, b as registerVersion, c as _getProvider, d as _registerComponent, h as getApp, j as createMockUserToken, n as SDK_VERSION, tt as updateEmulatorBanner, u as _isFirebaseServerApp, w as Component, z as getModularInstance } from "./index.esm2017-DghwDOiZ.js";
...
function _listAllHelper() {
	_listAllHelper = _asyncToGenerator(function* (ref, accumulator, pageToken) {
		const nextPage = yield list$1(ref, { pageToken });
		accumulator.prefixes.push(...nextPage.prefixes);
		accumulator.items.push(...nextPage.items);
		if (nextPage.nextPageToken != null) yield listAllHelper(ref, accumulator, nextPage.nextPageToken);
	});
	return _listAllHelper.apply(this, arguments);
}
/**
	...
	*/
	...
	_getAuthToken() {
		...
		return _asyncToGenerator(function* () {
			if (_this._overrideAuthToken) return _this._overrideAuthToken;
			const auth = _this._authProvider.getImmediate({ optional: true });
			if (auth) {
	...
	_getAppCheckToken() {
		var _this2 = this;
		return _asyncToGenerator(function* () {
			if (_isFirebaseServerApp(_this2.app) && _this2.app.settings.appCheckToken) return _this2.app.settings.appCheckToken;
			const appCheck = _this2._appCheckProvider.getImmediate({ optional: true });
			if (appCheck) return (yield appCheck.getToken()).token;
			return null;
		})();
	}
	/**
...
*/
function getBytes$2(ref, maxDownloadSizeBytes) {
...
* @returns A Promise containing an UploadResult
*/
function uploadBytes$2(ref, data, metadata) {
	ref = getModularInstance(ref);
...
* @returns A Promise containing an UploadResult
*/
function uploadString$2(ref, value, format, metadata) {
	ref = getModularInstance(ref);
...
* @returns An UploadTask
*/
function uploadBytesResumable$2(ref, data, metadata) {
	ref = getModularInstance(ref);
...
*/
function updateMetadata$3(ref, metadata) {
	ref = getModularInstance(ref);
...
*/
function getStorage$1(app = getApp(), bucketUrl) {
	app = getModularInstance(app);
	const storageInstance = _getProvider(app, STORAGE_TYPE).getImmediate({ identifier: bucketUrl });
	const emulator = getDefaultEmulatorHostnameAndPort("storage");
	if (emulator) connectStorageEmulator$2(storageInstance, ...emulator);
...
* @public
*/
function connectStorageEmulator$2(storage, host, port, options = {}) {
...
*/
function getBlob$2(ref, maxDownloadSizeBytes) {
	ref = getModularInstance(ref);
...
*/
function getStream$1(ref, maxDownloadSizeBytes) {
...
function percentage$1(task) {
	return fromTask$1(task).pipe(map(function(snapshot) {
		return {
...
//#endregion
//#region node_modules/@angular/fire/fesm2022/angular-fire-storage.mjs
var _StorageModule;
var Storage = class {
	constructor(auth) {
		return auth;
...
function storageInstanceFactory(fn) {
	return (zone, injector) => {
		return new Storage(zone.runOutsideAngular(() => fn(injector)));
	};
}
...
_defineProperty(StorageModule, "ɵfac", function StorageModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _StorageModule)();
});
_defineProperty(StorageModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({ type: _StorageModule }));
_defineProperty(StorageModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ providers: [DEFAULT_STORAGE_INSTANCE_PROVIDER, STORAGE_INSTANCES_PROVIDER] }));
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StorageModule, [{
		type: NgModule,
		args: [{ providers: [DEFAULT_STORAGE_INSTANCE_PROVIDER, STORAGE_INSTANCES_PROVIDER] }]
	}], () => [], null);
})();
...
var fromTask = ɵzoneWrap(fromTask$1, true);
var percentage = ɵzoneWrap(percentage$1, true);
var connectStorageEmulator = ɵzoneWrap(connectStorageEmulator$2, true);
var deleteObject = ɵzoneWrap(deleteObject$3, true, 2);
var getBlob = ɵzoneWrap(getBlob$2, true);
var getBytes = ɵzoneWrap(getBytes$2, true);
var getDownloadURL = ɵzoneWrap(getDownloadURL$2, true);
var getMetadata = ɵzoneWrap(getMetadata$3, true);
var getStorage = ɵzoneWrap(getStorage$1, true);
var getStream = ɵzoneWrap(getStream$1, true);
var list = ɵzoneWrap(list$3, true);
var listAll = ɵzoneWrap(listAll$2, true);
var ref = ɵzoneWrap(ref$2, true, 2);
var updateMetadata = ɵzoneWrap(updateMetadata$3, true, 2);
var uploadBytes = ɵzoneWrap(uploadBytes$2, true);
var uploadBytesResumable = ɵzoneWrap(uploadBytesResumable$2, true);
var uploadString = ɵzoneWrap(uploadString$2, true);
//#endregion
export { Storage, StorageError, StorageErrorCode, StorageInstances, StorageModule, StringFormat, FbsBlob as _FbsBlob, Location as _Location, TaskEvent as _TaskEvent, TaskState as _TaskState, UploadTask as _UploadTask, dataFromString as _dataFromString, _getChild, invalidArgument as _invalidArgument, invalidRootOperation as _invalidRootOperation, connectStorageEmulator, deleteObject, fromTask, getBlob, getBytes, getDownloadURL, getMetadata, getStorage, getStream, list, listAll, percentage, provideStorage, ref, storageInstance$, updateMetadata, uploadBytes, uploadBytesResumable, uploadString };
